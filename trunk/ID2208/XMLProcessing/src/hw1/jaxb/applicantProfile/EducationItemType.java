...
/**
 * <p>Java class for educationItemType complex type.
 * 
...
@XmlType(name = "educationItemType", propOrder = {
    "university",
    "degree",
    "courses",
    "gpa"
})
public class EducationItemType {
    ...
    @XmlElement(namespace = "http://www.example.org/ApplicantProfile")
    protected float gpa;
