...
public class Assignment1aMain extends ComponentDefinition {
	...
	public Assignment1aMain() {
		...
		connect(app.getNegative(PfdLink.class), pfd.getPositive(PfdLink.class));
		connect(app.getNegative(Timer.class), timer.getPositive(Timer.class));
		
		connect(pfd.getNegative(PfdLink.class), pp2p.getPositive(PfdLink.class));
		connect(pfd.getNegative(Timer.class), timer.getPositive(Timer.class));

		connect(pp2p.getNegative(Timer.class), timer.getPositive(Timer.class));
